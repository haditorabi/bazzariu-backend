export default [
  ...
  { name: 'Cameroonian Franc', code: 'CDF' },
  { name: 'Canadian Dollar', code: 'CAD' },
  { name: 'Cape Verdean Escudo', code: 'CVE' },
  { name: 'Cayman Islands Dollar', code: 'KYD' },
  { name: 'Central African CFA Franc', code: 'CFA' },
  { name: 'Chilean Peso', code: 'CLP' },
  { name: 'Chinese Yuan', code: 'CNY' },
  { name: 'Colombian Peso', code: 'COP' },
  { name: 'Comorian Franc', code: 'COM' },
  { name: 'Congolese Franc', code: 'COG' },
  ...
  { name: 'Gabonese CFA Franc', code: 'GAB' },
