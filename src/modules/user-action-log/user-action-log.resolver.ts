...
import { PaginatedUserActionLog } from 'src/graphql/paginated-response';
...
export class UserActionLogResolver {
  ...
  @Query(() => PaginatedUserActionLog)
  async allUserActionLog(@Args() paginationArgs: PaginationArgs) {
