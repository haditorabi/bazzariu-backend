...
import { PaginatedBusinessCategory } from 'src/graphql/paginated-response';
...
export class BusinessCategoryResolver {
  ...
  @Query(() => PaginatedBusinessCategory)
  async allBusinessCategory(@Args() paginationArgs: PaginationArgs) {
